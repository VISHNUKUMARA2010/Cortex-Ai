        ...
        if st.session_state.settings_page == "profile":
            ...
            if backend_options:
                ...
                if st.session_state.backend == 'openrouter':
                    ...
                    # Get display names and model keys
                    ...
                    # Radio button toggle for model selection
                    ...
                    # Get the actual model key from the selected label
        ...
        try:
            if st.session_state.backend == 'openrouter':
                if OPENAI_AVAILABLE and openai is not None:
                    ...
                    api_key = os.environ.get('OPENROUTER_API_KEY', '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')
